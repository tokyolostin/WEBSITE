...
.table-hover tbody tr:hover {
  ...
  <header class="navbar navbar-dark bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">BUY ME </a>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <tr>
            ...
            <td><a class="btn btn-primary" href="delete_product.php?order_id=<?php echo $product['order_id']; ?>">delete</a></td>
        </tr>
    <?php } ?>
