    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="form-group mt-2">
            ...
            <input type="number" class="form-control" id="product-offer" name="offer" placeholder="sale%" >
        </div>
        <div class="form-group mt-2">
            <label>image1</label>
        ...
        <div class="form-group mt-2">
            <label>image2</label>
            <input type="file" class="form-control" id="image2" name="image2" placeholder="image2"  >
        </div>
        <div class="form-group mt-2">
            <label>image3</label>
            <input type="file" class="form-control" id="image3" name="image3" placeholder="image3"  >
        </div>
        <div class="form-group mt-2">
            <label>image4</label>
            <input type="file" class="form-control" id="image4" name="image4" placeholder="image4"  >
        </div>
        <div class="form-group mt-2">
